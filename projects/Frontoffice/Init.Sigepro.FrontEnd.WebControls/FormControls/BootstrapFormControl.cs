...
namespace Init.Sigepro.FrontEnd.WebControls.FormControls
{
    ...
    public abstract class BootstrapFormControl<T> : WebControl, IControlWithLabel, IBootstrapFormControl where T : WebControl
    {
        ...
        public string Type
        {
            get { object o = this.ViewState["Type"]; return o == null ? String.Empty : (string)o; }
            set { this.ViewState["Type"] = value; }
        }

        public string InnerCssClass
        {
            get { object o = this.ViewState["InnerCssClass"]; return o == null ? String.Empty : (string)o; }
            set { this.ViewState["InnerCssClass"] = value; }
        }
        ...
        protected override void Render(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            if (!String.IsNullOrEmpty(this.Label))
            {
                ...
                if (!String.IsNullOrEmpty(this.IdRisorsa))
                {
                    writer.WriteBeginTag("span");
                    writer.WriteAttribute("class", "risorsa-testuale");
                    writer.WriteAttribute("style", "display: inline-block");
                    writer.WriteAttribute("data-id-risorsa", IdRisorsa);
                    writer.Write(System.Web.UI.HtmlTextWriter.TagRightChar);
                    
                    var testoLabel = this._risorseService.GetRisorsa(IdRisorsa, this.Label);
                    writer.Write(testoLabel);
            ...
            {
                this._innerControl.Attributes["type"] = this.Type;
            }

            if (!String.IsNullOrEmpty(this.InnerCssClass))
            {
                this._innerControl.CssClass += " " + this.InnerCssClass;
            }
