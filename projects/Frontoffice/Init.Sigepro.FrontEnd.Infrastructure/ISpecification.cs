...
namespace Init.Sigepro.FrontEnd.Infrastructure
{
    ...
    internal class AndNotSpecification<TEntity> : ISpecification<TEntity>
    {
        private ISpecification<TEntity> _specificationOne;
        private ISpecification<TEntity> _specificationTwo;

        internal AndNotSpecification(ISpecification<TEntity> specificationOne,
          ISpecification<TEntity> specificationTwo)
        {
            this._specificationOne = specificationOne;
            this._specificationTwo = specificationTwo;
    ...
    public static class SpecificationExtensionMethods
    {
        ...
        public static ISpecification<TEntity> AndNot<TEntity>(this ISpecification<TEntity> specificationOne, ISpecification<TEntity> specificationTwo)
        {
            return new AndNotSpecification<TEntity>(specificationOne, specificationTwo);
        }
