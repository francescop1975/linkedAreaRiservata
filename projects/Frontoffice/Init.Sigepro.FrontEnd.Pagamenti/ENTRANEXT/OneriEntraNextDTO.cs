...
namespace Init.Sigepro.FrontEnd.Pagamenti.ENTRANEXT
{
    public class OneriEntraNextDTO
    {
        ...
        public OneriEntraNextDTO( string descrizione, decimal importo, decimal quantita, decimal iva, IVA? aliquotaIva, string numeroAccertamentoContabile, string codiceCausalePeople)
        {
