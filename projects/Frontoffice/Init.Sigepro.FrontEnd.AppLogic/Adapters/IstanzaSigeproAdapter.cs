...
namespace Init.Sigepro.FrontEnd.AppLogic.Adapters
{
    public partial class IstanzaSigeproAdapter
    {
        ...
        [Inject]
        public IDateTimeServiceWrapper _dateTimeServiceWrapper { get; set; }


        private string _idComuneTradotto;
        private readonly IDomandaOnlineReadInterface _readInterface;
        private readonly IstanzaSigeproAdapterFlags _adapterFlags;

        [Obsolete("Utilizzare la classe IIstanzaSigeproAdaperService")]
        public IstanzaSigeproAdapter(IDomandaOnlineReadInterface readInterface, bool aggiungiPdfSchedeAListaAllegati = true)
        {
            ...
            this._adapterFlags = new IstanzaSigeproAdapterFlags
            {
        ...
        public Istanze ToIstanzaBackoffice()
        {
			...
			*/
            ...
            return istanzaSigepro;
        }
        /*
        public string ToXmlModelloRiepilogo(string codiceDomandaFo)
        {
            Istanze istanza = ToIstanzaBackoffice();

            istanza.NUMEROISTANZA = codiceDomandaFo;

            return istanza.ToXmlModelloRiepilogo();
        }
        */
        ...
        private void FillDocumenti(Istanze istanzaOut)
        {
            ...
            if (_readInterface.DelegaATrasmettere.Allegato != null)
            {
                ...
                documenti.Add(_readInterface.DelegaATrasmettere.Allegato.ToDocumentiIstanza(descrizioneDelega, this._dateTimeServiceWrapper));
            }
            ...
            if (_readInterface.DelegaATrasmettere.DocumentoIdentita != null)
            {
                ...
                documenti.Add(_readInterface.DelegaATrasmettere.DocumentoIdentita.ToDocumentiIstanza(descrizione, this._dateTimeServiceWrapper));
            }
            ...
            foreach (var riepilogodd in _readInterface.RiepiloghiSchedeDinamiche.GetRiepiloghiInterventoConAllegatoUtente())
            {
                ...
                if (rigaModello.TipoFirma == ModelloDinamico.TipoFirmaEnum.Nessuna && !this._adapterFlags.AggiungiPdfSchedeAListaAllegati)
                {
                    continue;
                }
