...
namespace Init.Sigepro.FrontEnd.AppLogic.Autenticazione.Vbg
{
	public class UserAuthenticationResult
	{
        ...
        public string IdComuneDb { get; private set; }

        public AnagraficaUtente DatiUtente { get; private set; }

        public LivelloAutenticazioneEnum LivelloAutenticazione { get; private set; }

		internal UserAuthenticationResult(string token, string idComune, string idComuneDb, AnagraficaUtente datiUtente, LivelloAutenticazioneEnum livelloAutenticazione)
		{
			this.Token = token;
