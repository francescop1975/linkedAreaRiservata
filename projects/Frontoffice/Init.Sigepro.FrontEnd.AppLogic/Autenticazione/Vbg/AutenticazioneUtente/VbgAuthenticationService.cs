...
namespace Init.Sigepro.FrontEnd.AppLogic.Autenticazione.Vbg.AutenticazioneUtente
{
	public class VbgAuthenticationService
	{
		...
		public VbgAuthenticationService(IAnagraficheService anagraficheService, IConfigurazione<ParametriLogin> configurazione, SigeproSecurityProxy sigeproSecurityProxy, IConfigurazione<ParametriSigeproSecurity> parametriSigeproSecurity, IAreaRiservataAuthenticationService areaRiservataAuthenticationService)
		{
            ...
            _areaRiservataAuthenticationService = areaRiservataAuthenticationService;
		...
		private UserAuthenticationResult LeggiDatiToken(string token)
		{
            ...
            if (result.tokenInfo.contesto == ContestoType.APP)
            {
                ...
                return new UserAuthenticationResult(token, result.tokenInfo.alias, result.tokenInfo.idcomune, null, LivelloAutenticazioneEnum.Anonimo);
            }
            else
            {
