...
{
    [Serializable]
    public class MenuItem : IMenuItemConUrl
    {
        ...
        public string Icona
        {
            get
            {
                if(!String.IsNullOrEmpty(this.IconaFontAwesome))
                {
                    return this.IconaFontAwesome;
                }

                if (!String.IsNullOrEmpty(this.IconaBootstrap))
                {
                    return $"glyphicon {this.IconaBootstrap}";
                }
