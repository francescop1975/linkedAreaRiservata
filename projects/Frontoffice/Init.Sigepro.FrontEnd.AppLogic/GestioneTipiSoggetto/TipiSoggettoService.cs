...
using Init.Sigepro.FrontEnd.AppLogic.Common;
	...
	public interface ITipiSoggettoService
	{
        ...
        IEnumerable<TipoSoggetto> GetTipiSoggettoObbligatori(int? codiceIntervento, string tipoDato);
        IEnumerable<TipoSoggetto> GetTipiSoggettoPersonaGiurudica(int? codiceIntervento);
        IEnumerable<TipoSoggetto> GetTipiSoggettoPersonaGiurudica(int? codiceIntervento, string tipoDato);
        IEnumerable<TipoSoggetto> GetTipiSoggettoPersonaFisica(int? codiceIntervento);
        IEnumerable<TipoSoggetto> GetTipiSoggettoPersonaFisica(int? codiceIntervento, string tipoDato);
    }
	...
	public class TipiSoggettoService : ITipiSoggettoService
	{
        ...
        public IEnumerable<TipoSoggetto> GetTipiSoggettoObbligatori(int? codiceIntervento, string tipoDato)
        {
            return this._tipiSoggettoRepository
                       .GetObbligatori(codiceIntervento)
                       .Where(x => x.TIPODATO == tipoDato)
                       .Select(x => new TipoSoggetto(x));
        }
        ...
        public IEnumerable<TipoSoggetto> GetTipiSoggettoPersonaGiurudica(int? codiceIntervento, string tipoDato)
        {
            return this._tipiSoggettoRepository
                       .GetTipiSoggettoPersonaGiurudica(codiceIntervento)
                       .Where(x => x.TIPODATO == tipoDato)
        ...
        public IEnumerable<TipoSoggetto> GetTipiSoggettoPersonaFisica(int? codiceIntervento, string tipoDato)
        {
            return this._tipiSoggettoRepository
           .GetTipiSoggettoPersonaFisica(codiceIntervento)
           .Where( x => x.TIPODATO == tipoDato )
