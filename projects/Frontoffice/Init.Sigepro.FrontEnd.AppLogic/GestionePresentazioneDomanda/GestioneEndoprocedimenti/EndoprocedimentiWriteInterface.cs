namespace Init.Sigepro.FrontEnd.AppLogic.GestionePresentazioneDomanda.GestioneEndoprocedimenti
{
	...
	public class EndoprocedimentiWriteInterface : IEndoprocedimentiWriteInterface
	{
		...
		public void AggiungiESincronizza(IEnumerable<SubEndoprocedimentoSelezionato> subEndo, LogicaSincronizzazioneSubEndo logicaSincronizzazioneEndo)
		{
			logicaSincronizzazioneEndo.Sincronizza(subEndo);
		}
