...
namespace Init.Sigepro.FrontEnd.GestioneMovimenti.GestioneMovimento.GestioneMovimentoDaEffettuare
{
    public interface IMovimentiDaEffettuareRepository
    {
        ...
        DocumentiIstanzaSostituibiliDto GetDocumentiSostituibili(int idMovimentoDaEffettuare);

        ConfigurazioneMovimentoDaEffettuareDto GetConfigurazioneMovimento(int idMovimento);
    }
}
