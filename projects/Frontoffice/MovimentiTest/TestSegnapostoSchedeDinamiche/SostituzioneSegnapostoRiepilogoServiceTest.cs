...
namespace MovimentiTest.TestSegnapostoSchedeDinamiche
{
    ...
    public class SostituzioneSegnapostoRiepilogoServiceTest
    {
        ...
        IIstanzaSigeproAdapterService _istanzaSigeproAdapter;
        ...
        public void TestInitialize()
        {
            ...
            _istanzaSigeproAdapter = new IstanzaSigeproAdapterService(Enumerable.Empty<IIstanzaSigeproPartialAdapter>(), null);
        ...
        public void ProcessaRiepilogo_SostituzioneSegnapostoSchedaConSchedaPresenteNellaDomanda_RestituisceDatiScheda()
        {
            ...
            var result = _sostituzioneService.ProcessaRiepilogo(new DomandaOnlineDatiDinamiciReader(this._domanda, _datiDinamiciRepository.Object, _istanzaSigeproAdapter), template);
