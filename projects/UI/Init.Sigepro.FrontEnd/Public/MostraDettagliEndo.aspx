...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<asp:Panel runat="server" ID="pnlDatiEndo" >
		...
		<div id="accordion" class="popupDettagliEndo inputForm dettagliIntervento panel-group" role="tablist" aria-multiselectable="true">
			...
			<% if (DataSource.Normative != null && DataSource.Normative.Count > 0) {%>
			<div>
				<h3>
					<a href="#">Normativa</a>
				</h3>
			...
			<% if (DataSource.TestiEstesi != null && DataSource.TestiEstesi.Count > 0) { %>
			<div>
				<h3>
			...
			<% if (DataSource.Oneri != null && DataSource.Oneri.Count > 0)  { %>
			<div>
				<h3>
					<a href="#">Oneri</a></h3>
				<div>
			...
			<% if (DataSource.Allegati != null && DataSource.Allegati.Count > 0) { %>
			<div>
