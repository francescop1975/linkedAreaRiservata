                ...
                <asp:Panel runat="server" ID="pnAllegati">
                    <fieldset>
                        ...
                        <asp:Repeater runat="server" ID="rptAllegati">
                            ...
                            <ItemTemplate>
                                <li><i>
                                    <asp:HyperLink ID="hlDownloadAllegato" CssClass="" runat="server" NavigateUrl='<%# Eval("UrlDownload") %>'
                                       ToolTip='<%# DataBinder.Eval(Container.DataItem, "NOMEFILE", "Scarica il file {0}") %>' 
                                        Text='<%# Eval("DESCRIZIONE") %>' />
                                    </i>&nbsp;&nbsp;
                                    <asp:Label runat="server" ID="lblNomeFile" 
                                        Text='<%# Eval("NOMEFILE") %>' />
                                    <asp:Label runat="server" ID="lblDimensioneFile" 
                                        Text='<%# DataBinder.Eval(Container.DataItem, "DIMENSIONEFILE","( {0})") %>' />
                                </li>
                            </ItemTemplate>
                            <FooterTemplate>
                                </ul>
