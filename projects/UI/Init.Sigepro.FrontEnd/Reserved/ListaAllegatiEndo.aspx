			...
			<ItemTemplate>
				<li>
					<b>
						...
						<asp:HyperLink runat="server" ID="hlDownload" target="_blank" Text='<%# Eval("ALLEGATOEXTRA") %>' NavigateUrl='<%# VirtualPathUtility.ToAbsolute( GeneraUrlDownload(DataBinder.Eval(Container,"DataItem"))) %>' /></b><br />
