        ...
        public override void DataBind()
        {
            gvProcure.DataSource = ReadFacade.Domanda
                                             ...
                                             .Select(x => new GrigliaProcureBindingItem
                                             {
                                                 ...
                                                 PathDownload = x.Allegato != null ? _urlDownloadOggettiService.GetUrlDownload(x.Allegato.CodiceOggetto) : String.Empty,
                                                 ...
                                                 DocIdentitaPathDownload = x.DocumentoIdentita != null ? _urlDownloadOggettiService.GetUrlDownload(x.DocumentoIdentita.CodiceOggetto) : String.Empty,
