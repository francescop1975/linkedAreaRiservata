...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
    public partial class GestioneInterventiAteco : IstanzeStepPage
    {
        ...
        {
            get { object o = this.ViewState["IntestazioneRicercaIntervento"]; return o == null ? String.Empty : (string)o; }
        ...
        public string MessaggioCollegamentoAtecoNonTrovato
        {
            get
            {
                object o = this.ViewState["MessaggioCollegamentoAtecoNonTrovato"];
        ...
        public override bool CanExitStep()
        {
            ...
            return VerificaPermessiInterventoSelezionato();
        }
        #endregion
        ...
        {
            VerificaPermessiInterventoSelezionato();
        ...
        protected void InterventoSelezionato(object sender, int idNodo)
        {
            ...
            if (VerificaPermessiInterventoSelezionato())
            {
