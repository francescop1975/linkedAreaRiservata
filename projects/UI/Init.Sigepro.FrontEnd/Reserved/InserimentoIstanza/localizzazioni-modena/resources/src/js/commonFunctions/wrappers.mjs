/**
 * questo modulo contiene delle funzioni di accesso ad elementi HTML
 */
...
export var wrappers = {
    object: {
         ...
         */
        getObjectFromDOMbySelector: function(selector) {
        ...
        /**
         * Data un elemento input, ritorna il valore
        ...
        /**
         * Data un elemento input, imposta il valore
         * @param {object} dropDownList 
         */
        ...
        /**
         * Data un elemento input, vuota il suo valore
         * @param {object} dropDownList 
         */
        emptyInputValue: function(inputElement) {
            var inputValue = undefined;
            if (config_ol.html_page_elments.use_jquery) {
         ...
         * @param {string} tag 
         */
        getChildrenByTag: function(parent, tag) {
         ...
         * @param {string} value
         */
        setInnerHtmlValue: function(htmlElement, value) {
            if (config_ol.html_page_elments.use_jquery) {
         ...
         */
        removeChildrenByTagAndDataAttribute: function(htmlElement, childrenTag, data_attribute_key, data_attribute_value) {
    ...
    dropdown: {
         ...
         */
        selectItemByValue: function(dropDownList, itemValue) {
            if (config_ol.html_page_elments.use_jquery) {
         ...
         * @param {object} dropDownList 
         */
        selectFirstItem: function(dropDownList) {
         ...
         */
        addItem: function(dropDownList, optionItem, refresh) {
            if (config_ol.html_page_elments.use_jquery) {
         ...
         * @param {object} dropDownList 
         */
        getSelectedValue: function(dropDownList) {
         ...
         * @param {object} dropDownList 
         */
        refreshAfterUpdate: function(dropDownList) {
    ...
    html_list: {
         ...
         * @param {object} item 
         */
        addItem: function(htmlList, item) {
            if (config_ol.html_page_elments.use_jquery) {
    ...
    event: {
         ...
         */
        addClickEventListener: function(htmlElement, method) {
            if (config_ol.html_page_elments.use_jquery) {
         ...
         * @param {function} method 
         */
        addChangeEventListener: function(htmlElement, method) {
            if (config_ol.html_page_elments.use_jquery) {
        ...
        /**
         * attiva un listener per evento keydown su elemento DOM.
         * quando l'evento viene scatenato, viene eseguita la funzione
         * associata
         * @param {object} htmlElement 
         * @param {function} method 
         */
        addKeydownEventListener: function(htmlElement, method) {
            if (config_ol.html_page_elments.use_jquery) {
                htmlElement.keydown(method);
            } else {
                htmlElement.addEventListener('keydown', method);
            }
        }
    }
