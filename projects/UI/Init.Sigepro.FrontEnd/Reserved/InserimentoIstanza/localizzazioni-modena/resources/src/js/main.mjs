import { 
	createMapLayers,
	initializeFormAndMap,
	onMapClick,
	setArrayParticelleInput,
	setCallBack
} from "./projectFunctions.mjs";
...
export var html_selectedFoglioTitolo, html_selectedParticelleHtmlList, html_createdParticelleHtmlList,
 ...
 */
export function run(paramParticelleInput, paramCallBack) {
