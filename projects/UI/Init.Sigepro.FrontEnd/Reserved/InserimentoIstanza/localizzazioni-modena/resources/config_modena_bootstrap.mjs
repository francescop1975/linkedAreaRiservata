/**
 * questo modulo contiene tutti i parametri di configurazione del programma
 */
...
export var config_ol = {
    ...
    html_page_elments: {
        ...
        //bottone che attiva apertura della finestra modale per aggiunta particella manuale
        button_open_modal_partkey: "#aggiungi_particella",
        ...
        //riferimento a elemento DOM contenente il titolo per la lista delle particelle selezionate
        selected_particelle_title: "#titolo_particelle_grafiche",
        //riferimento a elemento DOM contenente la lista delle particelle create
        created_particelle_div: "#lista_particelle_create",
        //riferimento a elemento DOM contenente il titolo per la lista delle particelle create
        created_particelle_title: "#titolo_particelle_manuali",
        ...
        //box modale per aggiunta particelle
        modal_box: "#addPartkeyManually",
        //campo input per particella in modal window
        modal_foglio_cell: "#foglio_selezionato_form_add",
        modal_particella_input: "#nuova_particella_input",
        modal_particella_button_confirm: "#button_confirm_modal_particella",
