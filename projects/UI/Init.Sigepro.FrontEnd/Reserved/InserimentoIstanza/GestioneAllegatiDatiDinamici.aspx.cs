...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
    public partial class GestioneAllegatiDatiDinamici : IstanzeStepPage
    {
        ...
        {
            var listaErrori = ReadFacade.Domanda.DatiDinamici.VerificaUploadModelliRichiesti(IgnoraObbligoFirmaDigitale);
		...
		public override void DataBind()
		{
			var dataSource = from r in ReadFacade.Domanda.RiepiloghiSchedeDinamiche.Riepiloghi
							 ...
							 select new AllegatiRiepiloghiBindingItem
							 {
								 ...
								 RichiedeFirmaDigitale	= !IgnoraObbligoFirmaDigitale && ReadFacade.Domanda.DatiDinamici.GetModelloById(r.IdModello).TipoFirma != ModelloDinamico.TipoFirmaEnum.Nessuna,
        ...
        protected void gvRiepiloghiDatiDinamici_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
				...
				ModelliDinamiciService.AggiungiOggettoRiepilogo(IdDomanda, idModello, indiceMolteplicita, file, IgnoraObbligoFirmaDigitale);
