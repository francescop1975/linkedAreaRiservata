...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
    public partial class GestioneDelegaATrasmettere : IstanzeStepPage
    {
        ...
        public override void DataBind()
        {
            ...
            this.delegaATrasmettereView.DataSource = GestioneDelegaATrasmettere_file_view.DelegaATrasmettereFileModel.FromAllegatoDomanda(IdComune, ReadFacade.Domanda.DelegaATrasmettere.Allegato, this.RichiedeFirma, this._urlDownloadOggettiService);
            this.documentoIdentitaView.DataSource = GestioneDelegaATrasmettere_file_view.DelegaATrasmettereFileModel.FromAllegatoDomanda(IdComune, ReadFacade.Domanda.DelegaATrasmettere.DocumentoIdentita, false, this._urlDownloadOggettiService);
        ...
        {
            return this._urlDownloadOggettiService.GetUrlDownloadPdfCompilabile(CodiceOggettoPdfCompilabile, IdDomanda);
        }
