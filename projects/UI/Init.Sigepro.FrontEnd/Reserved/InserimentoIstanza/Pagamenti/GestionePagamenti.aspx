...
<%@ Register TagPrefix="uc1" TagName="GrigliaPagamentoOneriMIP" Src="~/Reserved/InserimentoIstanza/Pagamenti/GrigliaPagamentoOneriMIP.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="stepContent" runat="server">
    ...
    <table id="tabellaEndo" class="table">
        <uc1:GrigliaPagamentoOneriMIP runat="Server" ID="grigliaOneriIntervento" />
        <uc1:GrigliaPagamentoOneriMIP runat="Server" ID="grigliaOneriEndo" />
