...
{
    public partial class GrigliaPagamentoOneriMIP : System.Web.UI.UserControl
    {
        public delegate List<KeyValuePair<string, string>> GetModalitaPagamentoSupportateDelegate();
        public event GetModalitaPagamentoSupportateDelegate GetModalitaPagamentoSupportate;
        ...
        public override void DataBind()
        {
            this.rptOneri.DataSource = DataSource.Select(x => new
            {
                ...
                Note = x.Note,
                DataPagamento = x.EstremiPagamento != null && x.EstremiPagamento.Data.HasValue ? x.EstremiPagamento.Data.Value.ToString("yyyy-MM-dd") : String.Empty,
        ...
        protected void rptOneri_ItemDataBound(object sender, System.Web.UI.WebControls.RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (this.GetModalitaPagamentoSupportate != null)
                {
                    ddl.Items.Clear();
                    foreach (var item in this.GetModalitaPagamentoSupportate())
                    {
