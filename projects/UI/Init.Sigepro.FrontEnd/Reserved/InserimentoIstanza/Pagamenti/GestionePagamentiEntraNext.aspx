...
<asp:Content ID="Content1" ContentPlaceHolderID="stepContent" runat="server">
    ...
    <table id="tabellaEndo" class="table">
        <uc1:GrigliaPagamentoOneri runat="Server" ID="grigliaOneriIntervento" OnGetModalitaPagamentoSupportate="GetModalitaPagamentoSupportate" />
        <uc1:GrigliaPagamentoOneri runat="Server" ID="grigliaOneriEndo" OnGetModalitaPagamentoSupportate="GetModalitaPagamentoSupportate" />
