<%@ Page Language="C#" MasterPageFile="~/Reserved/InserimentoIstanza/InserimentoIstanzaMaster.Master" EnableEventValidation="false" AutoEventWireup="true" 
    CodeBehind="GestioneAnagraficheSemplificata.aspx.cs" Inherits="Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza.GestioneAnagraficheSemplificata" Title="Gestione Anagrafiche" %>
...
<asp:Content runat="server" ContentPlaceHolderID="head" ID="headContent">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#tipo-soggetto-bottom").append($(".dati-anagrafici #tipo-soggetto"));
        });        
    </script>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="stepContent" runat="server">
    ...
    <div>
        <asp:Literal runat="server" ID="ltrTestoSostitutivo"></asp:Literal>
    </div>
    </br>
    <asp:MultiView runat="server" ID="multiview" ActiveViewIndex="0" OnActiveViewChanged="multiview_ActiveViewChanged">
        ...
        <asp:View runat="server" ID="nuovoView">
            <script type="text/javascript">
                ...
                function ImpostaLabelCodiceFiscale(ddlTipoPersona, txtCodiceFiscale)
                {
                    var lbl = txtCodiceFiscale.parent().find('label'),
                ...
                $(function () {
                    ...
                    var divPopUp = $("#<%=bmErroreValidazione.ClientID%>")

                    verificaObserver = new VerificaCodiceFiscalePartitaIvaObserver(ddlTipoPersona, txtCodiceFiscale, cmdSubmit, divPopUp);

                    ImpostaLabelCodiceFiscale(ddlTipoPersona, txtCodiceFiscale);

                    //ddlTipoPersona.on('change', ImpostaLabelCodiceFiscale(ddlTipoPersona, txtCodiceFiscale));
                    //ddlTipoPersona.trigger('change');
                });
            ...
            <ar:DropDownList ID="cmbTipoPersona" runat="server" Label="Tipo soggetto" HasFeedback="false" Visible="false" AutoPostback="true" >
            ...
            <div>
                ...
                <cc2:ComboTipiSoggetto ID="TipoSoggetto" runat="server" TipoSoggetto="F" class="form-control" required />
            </div>
        ...
        <asp:View runat="server" ID="personaFisicaView">
            ...
            <uc1:DettagliAnagraficaPf runat="server" ID="DettagliPf" />
        </asp:View>
