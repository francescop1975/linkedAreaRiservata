...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
    public partial class GestioneEndoPresenti_Allegati : IstanzeStepPage
    {
        ...
        {
            var allegatiEndo = from r in ReadFacade.Domanda.Endoprocedimenti.Acquisiti.CheRichiedonoAllegato(this._endoAcquisitiService)
                               select new AllegatiEndoPresentiBindingItem
                               {
                                   Id = r.Codice,
                                   Descrizione = r.Descrizione,
                                   RichiedeFirmaDigitale = VerificaFirmeDigitaliAllegatiSeRichiesto && r.RichiedeFirmaDigitale(this._endoAcquisitiService),
        ...
        protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                _endoAcquisitiService.AllegaFileAEndoAcquisito(IdDomanda, codiceInventario, file, false);
        ...
        protected void OnRowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                _endoService.RimuoviAllegatoDaEndo(IdDomanda, codiceInventario);
