...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
    public partial class RiepilogoDomandaHtml : IstanzeStepPage
    {
        ...
        public override void DataBind()
        {
            ...
            if (esitoVerificaAccesso != RisultatoVerificaAccessoIntervento.Accessibile)
            {
        ...
        protected string GetUrlVersioneStampabile()
        {
            ...
            return _urlService.GetUrlDownloadCompilato(rigaRiepilogo.CodiceOggettoModello.Value, IdDomanda, FormatoConversioneEnum.PDF);
        }
