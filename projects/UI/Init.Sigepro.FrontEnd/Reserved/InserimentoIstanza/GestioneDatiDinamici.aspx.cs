...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
    public partial class GestioneDatiDinamici : IstanzeStepPage
    {
        ...
        {
            get { object o = this.ViewState["TestoCompilazioneSchedeObbligatorie"]; return o == null ? "(*) E' necessario compilare tutte le schede contrassegnate con un asterisco" : (string)o; }
            set { this.ViewState["TestoCompilazioneSchedeObbligatorie"] = value; }
        }

        public string TestoSchedeDellIntervento
        {
            get { object o = this.ViewState["TestoSchedeDellIntervento"]; return o == null ? "Schede dell'intervento" : (string)o; }
        ...
        {
            _modelliDinamiciService.SincronizzaModelliDinamici(IdDomanda, IgnoraSchedaCittadinoExtracomunitario);
        }
        ...
        public void OnSchedaEliminata(object sender, EventArgs e)
        {
            try
            {
                ...
                _modelliDinamiciService.EliminaModello(IdDomanda, idModello, indiceModello);
        ...
        {
            var indici = _modelliDinamiciService.GetIndiciScheda(IdDomanda, idScheda);
        ...
        private bool Salva()
        {
            try
            {
                ...
                _modelliDinamiciService.Salva(IdDomanda, renderer.DataSource);
        ...
        private void CaricaSchedaDinamica(int idScheda, int indiceScheda)
        {
            ...
            var scheda = _modelliDinamiciService.GetModelloDinamico(IdDomanda, idScheda, indiceScheda);
			...
			*/
            ...
            paginatoreSchedeDinamiche.IndiciSchede = _modelliDinamiciService.GetIndiciScheda(IdDomanda, idScheda);
