                ...
                <script type="text/javascript">
                    ...
                    $(function () {
                        ...
                        function DialogValidazione() {
                            return {
                                mostra: function () {
                                    $('#<%=modalValidazione.ClientID%>').modal('show');
                                },
                                nascondi: function () {
                                    $('#<%=modalValidazione.ClientID%>').modal('hide');
                                }
                            }
                        }
                        ...
                        campi.codViario.parent().find('input[type=\'text\']').on('input', (e) => {
                            campi.civico.val('');
                            campi.esponente.val('');
                        ...
                        function validate(el) {
                            ...
                            const campoErrore = formGroup.find('.input-validation');
                            ...
                            const onSuccess = function (d) {
                                ...
                                validatedFields.removeClass('has-error');
                        ...
                        function RicercaSit($) {
                            ...
                            var serviceUrl = urlListaCampi,
                                bindAutocomplete = function (el) {
                                    ...
                                    el.parent().parent().append("<span class='input-validation help-block with-errors' />");
...
<%--                <div id="dialog-validazione" style="display: none">
                ...
                <ar:BootstrapModal runat="server" ID="modalValidazione" ShowOkButton="false" ShowKoButton="false" Title="Validazione dei dati in corso">
                    <ModalBody>
                        <div>
                            Validazione dei dati immessi, attendere senza effettuare altre operazioni.
                        </div>
