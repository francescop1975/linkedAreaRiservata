...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="contenuto-step">
        ...
        <div runat="server" visible='<%# Convert.ToInt32(DataBinder.Eval( DataSource , "Allegati.Count" )) > 0 %>'>
            ...
            <asp:GridView ID="dgAllegatiMovimento" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="lnkMostraAllegato" NavigateUrl='<%# UrlDownload( Eval( "IdAllegato")) %>' Target="_blank" Text='Scarica' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
        ...
        <div id="bottoniMovimento">
            <asp:Button CssClass="btn btn-default" runat="server" ID="cmdChiudi" Text="Chiudi" OnClick="cmdChiudi_Click" />
