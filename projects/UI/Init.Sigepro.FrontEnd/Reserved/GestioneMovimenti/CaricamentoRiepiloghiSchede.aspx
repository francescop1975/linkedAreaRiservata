...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div id="contenutoStep">
		<div class="descrizioneStep">
			<ar:RisorsaTestualeLabel runat="server" IdRisorsa="movimenti.carica-riepiloghi.descrizione-step" ValoreDefault="">
			</ar:RisorsaTestualeLabel>
		</div>
		<div class="inputForm">
				<h2>
					<ar:RisorsaTestualeLabel runat="server" IdRisorsa="movimenti.carica-riepiloghi.titolo-griglia">
						Verifica schede compilate
					</ar:RisorsaTestualeLabel>
				</h2>
						...
						<asp:TemplateField HeaderText="Documento"  ItemStyle-Width="35%">
							<ItemTemplate>
								<asp:HyperLink runat="server" 
												...
												Target="_blank" 
												NavigateUrl='<%# UrlDownload(Eval( "CodiceOggetto"))%>' 
												Text='<%# Eval("NomeFile") %>'
...
<%--								<asp:LinkButton runat="server" 
				...
				<div id="bottoniMovimento">
					<asp:Button CssClass="btn btn-default" runat="server" ID="cmdTornaIndietro" Text="Torna indietro" OnClick="cmdTornaIndietro_Click" />
					<asp:Button CssClass="btn btn-primary" runat="server" ID="cmdProcedi" Text="Procedi" OnClick="cmdProcedi_Click" />
				</div>
		</div>
	</div>
</asp:Content>
