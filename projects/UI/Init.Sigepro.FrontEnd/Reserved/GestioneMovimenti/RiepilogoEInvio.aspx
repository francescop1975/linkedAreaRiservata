...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="inputForm">
        ...
        <%if (MovimentoDaEffettuare.Allegati.Count() > 0) {%>
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="<%= ResolveClientUrl(UrlDownload(allegato.IdAllegato)) %>" target="_blank">
                        <i><%=allegato.Note%></i>
                    </a>
                </li>
                <%} %>
        ...
        <div id="divComandi">
            ...
            <asp:Button runat="server" CssClass="btn btn-primary" ID="cmdConferma" OnClick="cmdConferma_Click" Text="Trasmetti" OnClientClick="return confermaInvio();" />
        </div>
