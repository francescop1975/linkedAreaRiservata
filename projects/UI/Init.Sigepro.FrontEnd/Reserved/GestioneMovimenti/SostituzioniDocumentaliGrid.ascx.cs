...
namespace Init.Sigepro.FrontEnd.Reserved.GestioneMovimenti
{
    ...
    public partial class SostituzioniDocumentaliGrid : System.Web.UI.UserControl
    {
        ...
        protected void rptDocumentiSostituibili_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                var fdFileSostitutivo = (FileDownload)e.Item.FindControl("fdFileSostitutivo");
                var dataItem = e.Item.DataItem as dynamic;

                if (dataItem.DocumentoSostitutivo != null)
                {
                    fdFileSostitutivo.DataSource = dataItem.DocumentoSostitutivo;
                    fdFileSostitutivo.DataBind();
                }
            }
        }
    }
