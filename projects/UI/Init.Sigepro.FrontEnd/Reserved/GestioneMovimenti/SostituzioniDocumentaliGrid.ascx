...
<asp:Repeater runat="server" ID="rptDocumentiSostituibili" OnItemDataBound="rptDocumentiSostituibili_ItemDataBound">
        ...
        <div class="panel panel-default documento-sostituibile">
            ...
            <div class="panel-body">
                <div class="file-originale">
                    <span>Nome file:</span>
                    <uc1:FileDownload ID="fdFileOriginale" runat="server" DataSource='<%# DataBinder.Eval(Container, "DataItem") %>'></uc1:FileDownload>
                </div>
                ...
                <asp:Panel runat="server" ID="pnlSostituzione" Visible='<%# DataBinder.Eval(Container.DataItem, "DocumentoSostitutivo") != null %>' Style="margin-top: 0.3em">
                    ...
                    <uc1:FileDownload ID="fdFileSostitutivo" runat="server"></uc1:FileDownload>
                </asp:Panel>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <p>
                            ...
                            <div>
                                <asp:FileUpload runat="server" ID="fuFileSostitutivo" CssClass="form-control upload-file-sostitutivo" Style="width: 100%; margin-top: 1.0em" />
                            </div>
                        </p>
                      </div>
                      <div class="modal-footer">
                        <asp:Button runat="server" ID="cmdSostituisciDocumento" 
                                    CssClass="btn btn-default cmd-upload-file-sostitutivo vbg-show-spinner" 
                                    Text="Conferma" 
