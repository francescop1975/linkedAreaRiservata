...
export var AppMapEventsEnum;
(function (AppMapEventsEnum) {
    AppMapEventsEnum[AppMapEventsEnum["PercorsoModificato"] = 0] = "PercorsoModificato";
    AppMapEventsEnum[AppMapEventsEnum["InizioRicalcoloPercorso"] = 1] = "InizioRicalcoloPercorso";
})(AppMapEventsEnum || (AppMapEventsEnum = {}));
export class AppMap extends AppEventHandler {
    constructor(mapElement, startingBounds) {
        super();
    ...
    aggiungiMarker(marker) {
        marker.setMap(this.map);
    }
    ricalcolaPercorso(waypoints) {
