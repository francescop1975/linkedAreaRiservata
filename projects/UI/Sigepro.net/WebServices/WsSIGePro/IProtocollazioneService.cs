...
namespace SIGePro.Net.WebServices.WsSIGePro
{
    ...
    public interface IProtocollazioneService
    {
        ...
        DatiProtocolloLetto LeggiProtocolloConData(string token, string idProtocollo, DateTime dataProtocollo, string numProtocollo, string software, string codiceComune);
        ...
        AllOut LeggiAllegatoStorico(string token, string idBase, string software, string codiceComune);
