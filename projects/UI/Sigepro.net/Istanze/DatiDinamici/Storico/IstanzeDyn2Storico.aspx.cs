...
namespace Sigepro.net.Istanze.DatiDinamici.Storico
{
	public partial class IstanzeDyn2Storico : BasePage
	{
		...
		{
			var dap = new IstanzeDyn2DataAccessFactory(Database, IdComune, CodiceIstanza);
			var loader = new ModelloDinamicoLoader(dap, IdComune, ModelloDinamicoLoader.TipoModelloDinamicoEnum.Backoffice);
			var modello = new ModelloDinamicoIstanza(loader, IdModello, IndiceScheda, true, IndiceVersione);
