...
namespace SIGePro.SIT.Tests.IntegrazioneRavenna2
{
	...
	public class Ra012TableTests
	{
		...
		{
			var table = new Ra012Table("", new OracleTableNameProvider());

			var result = table.AllFields().ToString();

			var expected = "RA012.numero, RA012.cod_via, RA012.cod_edif, RA012.parte, RA012.foglio, RA012.particella, RA012.sezione, RA012.indirizzo, RA012.cod_sez, RA012.CAP";
