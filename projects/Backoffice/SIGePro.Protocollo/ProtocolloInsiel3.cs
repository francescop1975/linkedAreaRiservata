...
using Init.SIGePro.Protocollo.Insiel3.Storico;
...
namespace Init.SIGePro.Protocollo
{
    public class PROTOCOLLO_INSIEL3 : ProtocolloBase, IProtocolloStorico
    {
        ...
        public override DatiProtocolloLetto LeggiProtocolloStorico(string idProtocollo, string annoProtocollo, string numeroProtocollo)
        {
            ...
            var par = new ParametriStoriciAdapter(base.DatiProtocollo.Token, base.DatiProtocollo.IdComuneAlias, base.DatiProtocollo.Software, base.DatiProtocollo.CodiceComune).Adatta();

            var codiceUfficio = par.CodiceUfficio;
            var separatore = SEPARATORE_ID_PROTOCOLLO;

            return new ServiceWrapperStorico(par, base._protocolloSerializer, base._protocolloLogs).LeggiProtocollo(idProtocollo, separatore, annoProtocollo, numeroProtocollo, codiceUfficio);
        }
        ...
        public override AllOut LeggiAllegatoStorico()
        {
            ...
            return new ServiceWrapperStorico(par, base._protocolloSerializer, base._protocolloLogs).LeggiAllegatoStorico(idAllegato, idProtocollo, separatore);
        }
    }
}
