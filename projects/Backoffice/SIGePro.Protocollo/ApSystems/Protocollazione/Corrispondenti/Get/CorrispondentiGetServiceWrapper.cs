        ...
        public corrispondenti.corrispondenteRow GetCorrispondenteByCodice(string codiceCorrispondente)
        {
            try
            {
                using (var ws = CreaWebService())
                {
                    ...
                    {
                        Logs.Warn($"TROVATO PIU' DI UN RISULTATO PER IL CODICE FISCALE / PARTITA IVA {codiceCorrispondente} E' STATO RECUPERATO IL PRIMO CORRISPONDENTE INDIVIDUATO NEL SISTEMA DI PROTOCOLLO");
                    }
