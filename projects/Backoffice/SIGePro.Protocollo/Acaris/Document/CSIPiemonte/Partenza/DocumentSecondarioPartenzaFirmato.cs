...
{
    public class DocumentSecondarioPartenzaFirmato: DocumentoArchivisticoIRC, IDocument
    {
        ...
        public DocumentSecondarioPartenzaFirmato(IProtocolloSerializer serializer, IDocumentResolver resolver, ObjectIdType idClassificazionePrincipale, AllegatoAcaris allegato)
        {
