...
{
    public class DocumentSecondarioPartenzaNonFirmato : DocumentoArchivisticoIRC, IDocument
    {
        ...
        public DocumentSecondarioPartenzaNonFirmato(IProtocolloSerializer serializer, IDocumentResolver resolver, ObjectIdType idClassificazionePrincipale, AllegatoAcaris allegato)
        {
