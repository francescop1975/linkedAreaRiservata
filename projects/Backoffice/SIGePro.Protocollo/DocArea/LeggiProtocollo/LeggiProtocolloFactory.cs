...
namespace Init.SIGePro.Protocollo.DocArea.LeggiProtocollo
{
    public class LeggiProtocolloFactory
    {
        ...
        public LeggiProtocolloFactory(ProtocolloEnum.FornitoreDocAreaEnum fornitore, string endPointAddress, string userName, string password, IProtocolloSerializer serializer)
        {
        ...
        public ILeggiProtocolloService GetService() 
        {
            switch (this._fornitore)
            {
                case ProtocolloEnum.FornitoreDocAreaEnum.ADS:
                    return new LeggiProtocolloService(this._endPointAddress, this._userName, this._password, this._serializer);
                ...
                default:
                    throw new NotImplementedException($"Il metodo per la lettura del protocollo non è implementato dal fornitore {this._fornitore.ToString()} ");
            }
        }
    }
}
