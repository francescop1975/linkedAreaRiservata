...
namespace Init.SIGePro.Protocollo.Prisma.LeggiProtocollo
{
    public class LeggiProtocolloServiceWrapper : ExtendedServiceWrapper
    {
        ...
        public LeggiProtocolloServiceWrapper(string url, ProtocolloLogs logs, IProtocolloSerializer serializer, CredentialsInfo credential) : base(url, logs, credential)
        {
            ...
            try
            {
                using (var ws = base.CreaWebService())
                {
                    using (OperationContextScope scope = new OperationContextScope(ws.InnerChannel))
                    {
                        ...
                        this._serializer.Serialize(ProtocolloLogsConstants.LeggiProtocolloResponseFileName, responseXml);
