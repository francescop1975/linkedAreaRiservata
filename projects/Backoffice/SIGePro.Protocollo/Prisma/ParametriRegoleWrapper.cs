...
namespace Init.SIGePro.Protocollo.Prisma
{
    public class ParametriRegoleWrapper
    {
        ...
        public bool AttivaSmistamentoArrivo { get; private set; }

        public bool ValorizzaDataDocumento { get; private set; }
        ...
        private void EstraiParametri()
        {
            ...
            this.AttivaSmistamentoArrivo = this._vert.AttivaSmistamentoArrivo == "1";
            this.ValorizzaDataDocumento = this._vert.ValorizzaDataDocumento == "1"; 
        }
    }
}
