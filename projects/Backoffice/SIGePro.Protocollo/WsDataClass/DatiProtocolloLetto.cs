...
namespace Init.SIGePro.Protocollo.WsDataClass
{
    ...
    public class DatiProtocolloLetto
    {
        ...
        /// <summary>
        /// Id del protocollo assegnato dal sistema di protocollazione
        /// </summary>
        [DataMember(Order = 1)]
        ...
        /// <summary>
        /// Oggetto descrittivo del protocollo
        /// </summary>
        [DataMember(Order = 5)]
        ...
        /// <summary>
        /// Codice della classifica del protocollo. Es. XIII.IV.I oppure un ID
        /// </summary>
        [DataMember(Order = 7)]
