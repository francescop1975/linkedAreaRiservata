...
namespace Init.SIGePro.Manager
{
    ...
    public class PosteggiTipoSpazioMgr : BaseManager
    {
        ...
        public List<PosteggiTipoSpazio> GetList(PosteggiTipoSpazio p_class, PosteggiTipoSpazio p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<PosteggiTipoSpazio>();
        }
