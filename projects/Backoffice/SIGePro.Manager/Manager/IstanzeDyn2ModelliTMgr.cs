...
namespace Init.SIGePro.Manager
{
    ...
    public partial class IstanzeDyn2ModelliTMgr
    {
		...
		private void InizializzaModello(IstanzeDyn2ModelliT cls)
		{
			...
			var dap = new IstanzeDyn2DataAccessFactory(db, cls.Idcomune, cls.Codiceistanza.GetValueOrDefault(int.MinValue));
			var loader = new ModelloDinamicoLoader(dap, cls.Idcomune, ModelloDinamicoLoader.TipoModelloDinamicoEnum.Backoffice);
            var modello = new ModelloDinamicoIstanza(loader, cls.FkD2mtId.GetValueOrDefault(int.MinValue), 0,false);
