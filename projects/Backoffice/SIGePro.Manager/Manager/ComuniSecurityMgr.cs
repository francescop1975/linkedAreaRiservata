...
{ 	///<summary>
	...
	public class ComuniSecurityMgr: BaseManager
	{
		...
		{
			var comunisecurity = db.GetClassList(pClass,true,false);
		...
		public List<ComuniSecurity > GetList(ComuniSecurity p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<ComuniSecurity> GetList(ComuniSecurity p_class, ComuniSecurity p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<ComuniSecurity>();
		}
