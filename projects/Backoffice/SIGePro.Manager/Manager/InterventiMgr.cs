...
{   ///<summary>
    ...
    public class InterventiMgr : BaseManager
    {
        ...
        public List<Interventi> GetList(Interventi p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<Interventi> GetList(Interventi p_class, Interventi p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<Interventi>();
        }
