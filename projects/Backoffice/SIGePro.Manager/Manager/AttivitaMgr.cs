...
namespace Init.SIGePro.Manager
{
    ...
    public class AttivitaMgr : BaseManager
    {
        ...
        public List<Attivita> GetList(Attivita p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<Attivita> GetList(Attivita p_class, Attivita p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<Attivita>();
        }
