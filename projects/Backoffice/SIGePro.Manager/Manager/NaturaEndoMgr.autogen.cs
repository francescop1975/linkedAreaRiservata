...
namespace Init.SIGePro.Manager
{
    public class NaturaEndoMgr : BaseManager
    {
        ...
        public List<NaturaEndo> GetList(NaturaEndo p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<NaturaEndo> GetList(NaturaEndo p_class, NaturaEndo p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<NaturaEndo>();
        }
    }
}
