...
namespace Init.SIGePro.Manager
{
    ...
    public class MailTipoMgr : BaseManager
    {
        ...
        public List<MailTipo> GetList(MailTipo p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<MailTipo> GetList(MailTipo p_class, MailTipo p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<MailTipo>();
        }
