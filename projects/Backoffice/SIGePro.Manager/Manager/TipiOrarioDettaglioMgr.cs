...
namespace Init.SIGePro.Manager
{
	...
	public class TipiOrarioDettaglioMgr: BaseManager
	{
		...
		public List<TipiOrarioDettaglio > GetList(TipiOrarioDettaglio p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<TipiOrarioDettaglio> GetList(TipiOrarioDettaglio p_class, TipiOrarioDettaglio p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<TipiOrarioDettaglio>();
		}
