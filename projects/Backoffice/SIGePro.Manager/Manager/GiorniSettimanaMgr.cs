...
namespace Init.SIGePro.Manager
{
    ...
    public class GiorniSettimanaMgr : BaseManager
    {
        ...
        public List<GiorniSettimana> GetList(GiorniSettimana p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<GiorniSettimana> GetList(GiorniSettimana p_class, GiorniSettimana p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<GiorniSettimana>();
        }
