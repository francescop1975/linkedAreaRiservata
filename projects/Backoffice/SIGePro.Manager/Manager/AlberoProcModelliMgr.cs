...
{   ///<summary>
    ...
    public class AlberoProcModelliMgr : BaseManager
    {
        ...
        public List<AlberoProcModelli> GetList(AlberoProcModelli p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<AlberoProcModelli> GetList(AlberoProcModelli p_class, AlberoProcModelli p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<AlberoProcModelli>();
        }
