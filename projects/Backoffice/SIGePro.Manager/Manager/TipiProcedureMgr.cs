...
{ 	///<summary>
	...
	public class TipiProcedureMgr : BaseManager
	{
		...
		public List<TipiProcedure> GetList(TipiProcedure p_class)
		{
			return this.GetList(p_class, null);
		}

		public List<TipiProcedure> GetList(TipiProcedure p_class, TipiProcedure p_cmpClass)
		{
			return db.GetClassList(p_class, p_cmpClass, false, false).ToList< TipiProcedure>();
		}
