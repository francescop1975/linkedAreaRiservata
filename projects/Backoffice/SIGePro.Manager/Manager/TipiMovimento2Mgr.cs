	...
	public class TipiMovimento2Mgr: BaseManager
{
		...
		public List<TipiMovimento2 > GetList(TipiMovimento2 p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<TipiMovimento2> GetList(TipiMovimento2 p_class, TipiMovimento2 p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<TipiMovimento2>();
		}
	#endregion
	}
}
