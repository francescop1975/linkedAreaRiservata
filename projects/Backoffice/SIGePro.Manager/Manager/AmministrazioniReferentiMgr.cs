...
namespace Init.SIGePro.Manager
{
	...
	public class AmministrazioniReferentiMgr: BaseManager
	{
		...
		public List<AmministrazioniReferenti> GetList(AmministrazioniReferenti p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<AmministrazioniReferenti> GetList(AmministrazioniReferenti p_class, AmministrazioniReferenti p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<AmministrazioniReferenti>();
		}
