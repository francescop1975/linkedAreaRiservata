	...
	public class TipologiaIstanzaMgr: BaseManager
{
		...
		public List<TipologiaIstanza > GetList(TipologiaIstanza p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<TipologiaIstanza> GetList(TipologiaIstanza p_class, TipologiaIstanza p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<TipologiaIstanza>();
		}
#endregion
	}
}
