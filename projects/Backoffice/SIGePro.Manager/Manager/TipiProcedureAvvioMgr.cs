	...
	public class TipiProcedureAvvioMgr: BaseManager
{
		...
		public List<TipiProcedureAvvio > GetList(TipiProcedureAvvio p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<TipiProcedureAvvio> GetList(TipiProcedureAvvio p_class, TipiProcedureAvvio p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<TipiProcedureAvvio>();
		}
