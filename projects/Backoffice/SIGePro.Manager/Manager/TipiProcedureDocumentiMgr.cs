	...
	public class TipiProcedureDocumentiMgr: BaseManager
{
		...
		public List<TipiProcedureDocumenti> GetList(TipiProcedureDocumenti p_class, TipiProcedureDocumenti p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<TipiProcedureDocumenti>();
		}
#endregion
	}
}