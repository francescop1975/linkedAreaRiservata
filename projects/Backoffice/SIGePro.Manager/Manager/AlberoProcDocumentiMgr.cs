	...
	public class AlberoProcDocumentiMgr: BaseManager
	{
		...
		public List<AlberoProcDocumenti> GetListDaCodiceIntervento(string idComune, int scId, AmbitoRicerca ambitoRicercaDocumenti)
		{
			...
			using (var cmd = db.CreateCommand(sql))
			{
				...
				return db.GetClassList<AlberoProcDocumenti>(cmd, new GetClassListFlags
				{
		...
		public List<AlberoProcDocumenti > GetList(AlberoProcDocumenti p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<AlberoProcDocumenti > GetList(AlberoProcDocumenti p_class, AlberoProcDocumenti p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList< AlberoProcDocumenti>();
		}
