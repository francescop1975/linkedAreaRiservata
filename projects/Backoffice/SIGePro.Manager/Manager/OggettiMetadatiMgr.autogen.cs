...
namespace Init.SIGePro.Manager
{
	...
	public partial class OggettiMetadatiMgr : BaseManager
	{
		...
		{
			List<OggettiMetadati> retVal = new List<OggettiMetadati>();
			...
			var sql = $@"SELECT 
							...
							WHERE 
								...
								CODICEOGGETTO = {_database.Specifics.QueryParameterName("CodiceOggetto")} AND 
								CHIAVE IN ('{String.Join("','", chiavi)}')";

			return _database.ExecuteReader(sql, mp =>
			{
