...
{   ///<summary>
    ...
    public class TipiAperturaMgr : BaseManager
    {
        ...
        public List<TipiApertura> GetList(TipiApertura p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<TipiApertura> GetList(TipiApertura p_class, TipiApertura p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<TipiApertura>();
        }
