	...
	public class TempiRispostaMgr: BaseManager
{
		...
		private void ForeignValidate ( TempiRisposta p_class )
		{
			...
			if ( !String.IsNullOrEmpty( p_class.CODICEAMMINISTRAZIONE ) )
			{
			...
			if ( !String.IsNullOrEmpty( p_class.TIPOCONTROMOVIMENTO ) )
			{
		...
		public List<TempiRisposta > GetList(TempiRisposta p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<TempiRisposta> GetList(TempiRisposta p_class, TempiRisposta p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<TempiRisposta>();
		}
