...
namespace Init.SIGePro.Manager
{
    ...
    public class ConcessioniUsoMgr : BaseManager
    {
        ...
        public List<ConcessioniUso> GetList(ConcessioniUso p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<ConcessioniUso> GetList(ConcessioniUso p_class, ConcessioniUso p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<ConcessioniUso>();
        }
