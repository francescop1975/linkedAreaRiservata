	...
	public class TipiOrarioMgr: BaseManager
{
		...
		public List<TipiOrario > GetList(TipiOrario p_class)
		{
			return this.GetList(p_class,null);
		}
	
		public List<TipiOrario> GetList(TipiOrario p_class, TipiOrario p_cmpClass )
		{
			return db.GetClassList(p_class,p_cmpClass,false,false).ToList<TipiOrario>();
		}
