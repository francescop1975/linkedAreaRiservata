...
namespace Init.SIGePro.Manager
{
    ...
    public class ConcessioniMgr : BaseManager
    {
        ...
        public List<Concessioni> GetList(Concessioni p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<Concessioni> GetList(Concessioni p_class, Concessioni p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<Concessioni>();
        }
