...
namespace Init.SIGePro.Manager
{
    ...
    public class TipiMovimentoOneriMgr : BaseManager
    {
        ...
        private void ForeignValidate(TipiMovimentoOneri p_class)
        {
            ...
            if (!String.IsNullOrEmpty(p_class.CODICECOMPORTAMENTO))
            {
            ...
            if (!String.IsNullOrEmpty(p_class.FK_COID))
            {
        ...
        public List<TipiMovimentoOneri> GetList(TipiMovimentoOneri p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<TipiMovimentoOneri> GetList(TipiMovimentoOneri p_class, TipiMovimentoOneri p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<TipiMovimentoOneri>();
        }
