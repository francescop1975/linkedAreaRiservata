...
{   ///<summary>
    ...
    public class IAttivitaMgr : BaseManager//, IIAttivitaManager
    {
        ...
        public List<IAttivita> GetList(IAttivita p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<IAttivita> GetList(IAttivita p_class, IAttivita p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<IAttivita>();
        }
