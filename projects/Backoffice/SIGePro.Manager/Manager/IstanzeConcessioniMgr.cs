...
{ 	
	public class IstanzeConcessioniMgr: BaseManager
	{
		...
		private void ForeignValidate( IstanzeConcessioni p_class )
		{
			...
			if ( !String.IsNullOrEmpty( p_class.FKCODICECAUSALE ) )
			{
			...
			if ( !String.IsNullOrEmpty( p_class.FKCODICECAUSALESTORICO ) )
			{
			...
			if ( !String.IsNullOrEmpty( p_class.FKCODICEISTANZA ) )
			{
			...
			if ( !String.IsNullOrEmpty( p_class.FKIDCONCESSIONE ) )
			{
