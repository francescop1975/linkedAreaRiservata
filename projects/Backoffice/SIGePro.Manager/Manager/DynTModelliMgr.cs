...
{   ///<summary>
    ...
    public class DynTModelliMgr : BaseManager
    {
        ...
        public List<DynTModelli> GetList(DynTModelli p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<DynTModelli> GetList(DynTModelli p_class, DynTModelli p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<DynTModelli>();
        }
