...
{   ///<summary>
    ...
    public class TipiContromovimentoMgr : BaseManager
    {
        ...
        private void ForeignValidate(TipiContromovimento p_class)
        {
            ...
            if (!String.IsNullOrEmpty(p_class.AMMMOV))
            {
            ...
            if (!String.IsNullOrEmpty(p_class.AMMRITSU))
            {
            ...
            if (!String.IsNullOrEmpty(p_class.CODICEPROCEDURA))
            {
        ...
        public List<TipiContromovimento> GetList(TipiContromovimento p_class)
        {
            return this.GetList(p_class, null);
        }

        public List<TipiContromovimento> GetList(TipiContromovimento p_class, TipiContromovimento p_cmpClass)
        {
            return db.GetClassList(p_class, p_cmpClass, false, false).ToList<TipiContromovimento>();
        }
