...
namespace Init.SIGePro.Manager.Logic.Cosap.Pisa.MezziPubblicitari.Permanenti
{
    public class TariffaMezziPubblicitariPermamenti : ITariffaMezziPubblicitari
    {
        ...
        public TariffaMezziPubblicitariPermamenti(double tariffa, IEnumerable<Soglia> soglie, double coefficienteStrada, double coefficienteOccupazione, double? coefficienteBifacciale, double? coefficienteLuminoso, int cifreDecimali)
        {
