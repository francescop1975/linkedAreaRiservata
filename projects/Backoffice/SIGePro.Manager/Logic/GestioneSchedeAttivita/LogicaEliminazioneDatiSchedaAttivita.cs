...
//						WHERE idcomune = {this._db.Specifics.QueryParameterName("idComune")} AND 
//							  fk_d2mt_id = {this._db.Specifics.QueryParameterName("idModello")} AND 
//							  fk_ia_id = {this._db.Specifics.QueryParameterName("idAttivita")}";

//			this._db.ExecuteNonQuery(sql, mp => {
//				mp.AddParameter("idComune", this._idComune);
//				mp.AddParameter("idModello", idModello);
//				mp.AddParameter("idAttivita", this._idAttivita);
//			});
//		}
...
//						WHERE idcomune  = {this._db.Specifics.QueryParameterName("idComune")} AND 
//							  fk_IA_ID  = {this._db.Specifics.QueryParameterName("idAttivita")} AND 
//							  FK_D2C_ID = {this._db.Specifics.QueryParameterName("idCampo")}";
