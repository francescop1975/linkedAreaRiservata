...
namespace Init.SIGePro.Verticalizzazioni
{
    public class VerticalizzazioneSitLdp : Verticalizzazione
    {
        ...
        {
            get { return GetString(Constants.UrlRitornoPraticaGIS); }
            set { SetString(Constants.UrlRitornoPraticaGIS, value); }
        }

        public string UrlPresentazioneIntegrazione
        {
            get { return GetString(Constants.UrlPresentazioneIntegrazione); }
            set { SetString(Constants.UrlPresentazioneIntegrazione, value); }
        }
