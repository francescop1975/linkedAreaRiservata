...
namespace Init.SIGePro.Verticalizzazioni
{
    ...
    ***************************************************************************************************************************************/
    ...
    /// </summary>
    public partial class VerticalizzazioneProtocolloAttivo : Verticalizzazione, IVerticalizzazioneProtocollo
    {
        private const string NOME_VERTICALIZZAZIONE = "PROTOCOLLO_ATTIVO";

        private static class Constants
        {
            public const string AbilitaIndirizziEmail = "ABILITA_INDIRIZZI_EMAIL";
            ...
            public const string VerificaDocumentiIstanza = "VERIFICA_DOCUMENTI_ISTANZA";
        ...
        public bool AbilitaIndirizziEmail => GetBool(Constants.AbilitaIndirizziEmail, false);
        ...
        /// </summary>
        public bool CreaCopiaFile => GetString(Constants.CreaCopiaFile) == "1";
        ...
        /// </summary>
        public bool CreaCopiaDescrFile => GetString(Constants.CreaCopiaDescrFile) == "1";
        ...
        /// </summary>
        public bool InviaEmlPecArrivo => GetString(Constants.InviaEmlPecArrivo) == "1";
        ...
        /// </summary>
        public bool AllegatiObbligatori => GetString(Constants.AllegatiObbligatori) == "1";
        ...
        /// </summary>
        public bool EstraiEml => GetString(Constants.EstraiEml) == "1";
        ...
        /// </summary>
        public bool EstraiZip => GetString(Constants.EstraiZip) == "1";
        ...
        /// </summary>
        public bool AllegaXmlDomandaStc => GetString(Constants.AllegaXmlDomandaStc) == "1";
        ...
        /// <summary>
        /// Valori: 0 (default) e 1. 
        /// Se impostato a 1 verifica che non siano presenti righe di DOCUMENTIISTANZA senza aver valorizzato CODICEOGGETTO, se presenti viene sollevata una eccezione
        /// Parametro utilizzato solamente in fase di protocollazione istanza in automatico
        /// </summary>
        public bool VerificaDocumentiIstanza => GetString(Constants.VerificaDocumentiIstanza) == "1";
