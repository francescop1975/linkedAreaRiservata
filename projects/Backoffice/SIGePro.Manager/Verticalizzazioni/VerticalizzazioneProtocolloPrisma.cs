...
namespace Init.SIGePro.Manager.Verticalizzazioni
{
    public class VerticalizzazioneProtocolloPrisma : Verticalizzazione
    {
        ...
        {
            get { return GetString("ATTIVA_SMISTAMENTO_ARRIVO"); }
            set { SetString("ATTIVA_SMISTAMENTO_ARRIVO", value); }
        }
        ...
        {
            get { return GetString("VALORIZZA_DATADOCUMENTO"); }
            set { SetString("VALORIZZA_DATADOCUMENTO", value); }
        }
