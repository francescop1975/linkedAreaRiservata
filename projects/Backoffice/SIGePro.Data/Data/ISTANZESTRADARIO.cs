...
namespace Init.SIGePro.Data
{
	...
	public class IstanzeStradario : BaseDataClass
	{
		...
		public override string ToString()
		{
            ...
            {
                sb.Append(Stradario.PREFISSO);
            }

			sb.Append(" ").Append(Stradario.DESCRIZIONE);
			...
			{
				sb.Append(" ").Append(Stradario.LOCFRAZ);
			}


			if (Stradario.Comune != null)
			{ 
				sb.Append(", ").Append(Stradario.Comune.COMUNE);

				sb.Append(" (").Append(Stradario.Comune.SIGLAPROVINCIA).Append(")");
			}
