...
namespace Init.SIGePro.DatiDinamici
{
    public class CampoDinamicoBase
    {
        ...
        public ListaValoriDatiDinamici ListaValori { get; }

        internal List<ErroreValidazione> ErroriScript { get; }
        ...
        public bool RichiedeEtichetta
        {
            get
            {
                return this.TipoCampo != TipoControlloEnum.Titolo &&
        ...
        public string Valore
        {
            get
            {
                ...
                {
                    throw new Exception("Campo " + this.NomeCampo + ": impossibile utilizzare la proprietà VALORE perchè il campo contiene valori multipli");
                }

                return this.ListaValori[0].Valore;
            }

            set => this.SetValore(value, value);
        }
        ...
        public void SetValore(string valore, string valoreDecodificato)
        {
            ...
            this.ListaValori[0].SetValore(valore, valoreDecodificato);
        }

        public readonly IDyn2DataAccessFactory DataAccessFactory;

        protected CampoDinamicoBase(ModelloDinamicoBase modello, IDyn2DataAccessFactory dataAccessFactory)
        {
        ...
        {
            this.ListaValori.SvuotaValori(notificaModifica);
        }
    }
}
