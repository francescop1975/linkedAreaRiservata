...
";
        ...
        {
            get { object o = ViewState["TipoLocalizzazione"]; return o == null ? String.Empty : o.ToString(); }
            set { ViewState["TipoLocalizzazione"] = value; }
        }

        public string FormatoIndirizzo
        {
            get { object o = ViewState["FormatoIndirizzo"]; return o == null ? String.Empty : o.ToString(); }
            set { ViewState["FormatoIndirizzo"] = value; }
        }
        ...
        {
            var query = DataAccessFactory.GetQueryLocalizzazioni();
