...
namespace Init.SIGePro.DatiDinamici.Contesti
{
	...
	public static class DatiDinamiciInfoDictionary
	{
		...
		private static void Initialize()
		{
            ...
            m_items.Add(ContestoModelloEnum.Mercati, new DatiDinamiciInfoDictionaryItem("MercatoCorrente", ContestoModelloEnum.Mercati, "Mercati"));
            m_items.Add(ContestoModelloEnum.Posteggi, new DatiDinamiciInfoDictionaryItem("PosteggioCorrente", ContestoModelloEnum.Posteggi, "Posteggi"));
        }
	}
}
