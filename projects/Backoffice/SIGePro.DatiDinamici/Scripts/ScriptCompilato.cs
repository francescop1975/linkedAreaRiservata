...
namespace Init.SIGePro.DatiDinamici.Scripts
{
	...
	internal class ScriptCompilato
	{
		...
		public object Esegui(CampoDinamicoBase campoModificato, int indiceCampoModificato, bool perIncrementoMolteplicita)
		{
			return this._metodoRuntime.Invoke(_objectInstance, new object[] { campoModificato, indiceCampoModificato, perIncrementoMolteplicita });
		}
