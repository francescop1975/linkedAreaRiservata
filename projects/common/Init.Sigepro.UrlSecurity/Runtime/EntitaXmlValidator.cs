...
{
    public class EntitaXmlValidator : ParameterValidatorBase
    {
        private readonly ILog _log = LogManager.GetLogger(typeof(EntitaXmlValidator));

        private static class Constants
        {
            public const string Regex = @"&#x[0-9a-f][0-9a-f];";
        }
