	...
	public partial class CampoObbligatorioValidatorTests
	{
		...
		public class ValidazioneCampiTestuali
		{
			...
			public void Initialize()
			{
				...
				this._campo = new CampoDinamicoStub(this._modello, null);
				this._idCampo = 666;
			...
			public void Valore_singolo_se_il_campo_non_e_obbligatorio_non_restituisce_errori()
			{
				...
				_campo.ListaValori[0].Valore = String.Empty;
				_campo.ListaValori[0].ValoreDecodificato = String.Empty;
			...
			{
				var messaggioErrore = "Campo obbligatorio";
				...
				Assert.AreEqual<string>(messaggioErrore, errors.ElementAt(0).Messaggio);
				Assert.AreEqual<string>(messaggioErrore, errors.ElementAt(1).Messaggio);
				Assert.AreEqual<int>(0, errors.ElementAt(0).Indice);
